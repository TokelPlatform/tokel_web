...
const SubmitButton = styled.button`
  ...
  background-color: ${p =>
    p.submitted ? 'var(--color-tellurian)' : 'var(--color-cornFlowerHard)'};
  color: #ffffff;
  border: none;
      ...
      <Content>
        <HeaderWrapper>
          <div>
            ...
            <h3>
              <a href={links.nftPodcastTop}>Voted in the Top 10 of best NFT podcasts</a>
            </h3>
            <h5>
              Listened to in 49 countries. Downloaded in 142 cities. Streamed on 7 social networks.
            </h5>
            <Desc>
              Tokel Talk is the live stream and podcast of open-source, dedicated, fungible &
              non-fungible token (NFT) platform Tokel. The Tokel platform provides end-to-end token
              solutions to creators, businesses and projects alike.
            </Desc>
          </div>
        </HeaderWrapper>
        <PlayerContainer>
          <iframe
            src="https://embed.podcasts.apple.com/us/podcast/tokel-talk/id1598762562?itsct=podcast_box_player&amp;itscg=30200&amp;ls=1&amp;theme=dark"
            height="450px"
            frameBorder="0"
        ...
        <ListenOn>{getPodcastLinks(data)}</ListenOn>
        <GuestSignUp>
          <h3 id="join-tokel-talk-as-a-guest">Join Tokel Talk as a Guest</h3>
          <p>
            Would you like to be the guest on Tokel Talk Podcast? If yes, please fill in the form
            below and we will get in touch with you as soon as we can.
          </p>
          <Formik
            initialValues={{
              guestName: '',
        ...
        <ReachOutToUs>
          If you are experiencing any difficulties, feel free to reach out to us in{' '}
          <a href={links.discord}>Tokel Discord</a> or email us at{' '}
          <a href={links.mailSupport}>contact@tokel.io</a>
        </ReachOutToUs>
      </Content>
    </PodcastRoot>
  );
